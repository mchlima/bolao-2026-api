...
const REGIONS: Record<string, { country: string; slugs: string[] }[]> = {
  'south-america': [
    ...
    { country: 'Brasil', slugs: ['bra.1', 'bra.2', 'bra.3'] },
    { country: 'Chile', slugs: ['chi.1', 'chi.2'] },
    { country: 'Colômbia', slugs: ['col.1', 'col.2'] },
    { country: 'Equador', slugs: ['ecu.1'] },
    { country: 'Peru', slugs: ['per.1'] },
    { country: 'Paraguai', slugs: ['par.1'] },
    { country: 'Bolívia', slugs: ['bol.1'] },
    { country: 'Uruguai', slugs: ['uru.1', 'uru.2'] },
    { country: 'Venezuela', slugs: ['ven.1'] },
  ],
  'central-north-america': [
    { country: 'Estados Unidos', slugs: ['usa.1', 'usa.usl.1', 'usa.usl.l1'] },
    { country: 'México', slugs: ['mex.1', 'mex.2'] },
  ...
  europe: [
    { country: 'Inglaterra', slugs: ['eng.1', 'eng.2', 'eng.3', 'eng.4', 'eng.5'] },
    { country: 'Espanha', slugs: ['esp.1', 'esp.2'] },
    { country: 'Itália', slugs: ['ita.1', 'ita.2'] },
    { country: 'Alemanha', slugs: ['ger.1', 'ger.2'] },
    { country: 'França', slugs: ['fra.1', 'fra.2'] },
    { country: 'Portugal', slugs: ['por.1'] },
    { country: 'Países Baixos', slugs: ['ned.1', 'ned.2', 'ned.3'] },
    { country: 'Bélgica', slugs: ['bel.1'] },
    { country: 'Escócia', slugs: ['sco.1', 'sco.2'] },
    { country: 'Turquia', slugs: ['tur.1'] },
    { country: 'Grécia', slugs: ['gre.1'] },
    { country: 'Rússia', slugs: ['rus.1'] },
    { country: 'Suíça', slugs: ['sui.1'] },
    { country: 'Áustria', slugs: ['aut.1'] },
    { country: 'Dinamarca', slugs: ['den.1'] },
    { country: 'Noruega', slugs: ['nor.1'] },
    { country: 'Suécia', slugs: ['swe.1'] },
    { country: 'República Tcheca', slugs: ['cze.1'] },
    { country: 'Romênia', slugs: ['rou.1'] },
    { country: 'Chipre', slugs: ['cyp.1'] },
    { country: 'Israel', slugs: ['isr.1'] },
    { country: 'Finlândia', slugs: ['fin.1'] },
  ...
  for (const { country, slugs } of groups) {
    ...
    await pool([...byId.values()], 5, async (t) => {
      try {
        ...
        const sigla = (t.abbreviation || t.displayName.slice(0, 3)).toUpperCase();
        const data = {
          name: t.displayName,
          shortName: sigla,
